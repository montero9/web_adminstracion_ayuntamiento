...
<html lang="es">
   ...
   <body>
      <?php
         ...
         if ($conexion) {
         	$resultado = mysqli_query($conexion,"SELECT id, fecha, nombre_persona,resuelta FROM incidencias WHERE resuelta=0 ORDER BY resuelta, fecha DESC");
         }
      ?>
         ...
         <div class="row">
            <div class="col-sm-4">
               ...
               <ul class="nav nav-pills nav-stacked">
                  <li><a href="listado_incidencias_resueltas.php">Incidencias&nbsp;resueltas</a></li>
               </ul>
            </div>
            <div class="col-sm-8">
