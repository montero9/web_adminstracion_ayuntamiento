            ...
            <?php
               ...
               require_once ('subir_imagen.inc'); 
                  ...
                  if(!$conexion){
                     ...
                     $fecha_re= $_POST['fecha'];
               
                     //Creamos la consulta y la ejecutamos
                     $query="INSERT INTO noticias (fecha,titulo,imagen,texto) values ('$fecha_re','$titulo_re','$direccion','$texto_re')";
                     $resultado=mysqli_query($conexion,$query);
               
                     //Comprobamos si se ha insertado o no 
                     if($resultado){
                        echo '<img src="../imagenes/correcto.jpg" /><br/>';
                        echo "<h3>La noticia ha sido insertada correctamente</h3>";
                     }else{
                        echo '<img src="../imagenes/error.jpg" /><br/>';
                        echo "<h3>No se ha podido insertar correctamente ".mysqli_error($conexion).'</h3>';
