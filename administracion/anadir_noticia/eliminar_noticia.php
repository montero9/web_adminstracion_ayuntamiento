<?php
   ...
   //Recogemos el identificador de la noticia y la url donde se encuentra la imagen que tenemos que borrar
   $id_noticia = $_GET['idnoticia'];
   $img_borrar= $_GET['ruta_imagen'];
      ...
      <div class="container" style="width: 100%" >
         <div class="col-sm-8" style="width: 100%" align="center">
            <?php
               ...
               if ($conexion) {
                  if(mysqli_query($conexion,"DELETE FROM noticias WHERE id=$id_noticia")){
                      
                      //Comprobamos que existe la foto de la noticia antes de intentar eliminarla
                      if(file_exists($img_borrar)){
                        unlink($img_borrar);
                      }
                  
                      echo '<img src="../imagenes/correcto.jpg" /><br/>';
                      echo "<h3>La noticia ha sido eliminada correctamente</h3>";
                      
                  }else{
                      echo '<img src="../imagenes/error.jpg" /><br/>';
                  echo "La noticia no ha podido ser eliminada";
                  }
               }
               ?>
         </div>
