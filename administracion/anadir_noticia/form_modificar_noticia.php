<?php
   ...
   //Comprobamos si la sesión está iniciada
     ...
     //Recogemos el identificador de la noticia
     $id_noticia = $_GET['idnoticia'];
   
        //Comprobamos la conexión, ejecutamos la consulta y asociamos las columnas con la variable
     if ($conexion) {
        $resultado=mysqli_query($conexion,"SELECT * FROM noticias WHERE id='$id_noticia'");
      ...
      <div class="container" style="width: 100%" >
         <div class="col-sm-8" style="width: 100%" align="center">
            <form action = "modificar_noticia.php" method = "post" enctype="multipart/form-data">
               <label>Id de noticia:&nbsp;&nbsp;<input type="text" name='idnoticia' value="<?php echo $id_noticia ?>" readonly size="5"></label><br/><br/>
               <label>Titulo: &nbsp;&nbsp;</label><input type="text" name = "titulo"  id="titulo" style="width: 50%" required value="<?php echo $fila['titulo'] ?>"><br /><br />
               <label>Imagen <b>(jpg/jpeg/png/gif <20Mb)</b>: </label> <input type = "file" name = "imagen" required /><br/><br />
               <label>Texto de la noticia: </label><br/><textarea name="texto" id="texto" required rows="20" style="width: 70%"><?php echo $fila['texto'] ?></textarea><br/><br />
